...
def compute_distance_matrix(input1, input2, metric='euclidean'):
    ...
    # assert input1.dim() == 3, 'Expected 3-D tensor, but got {}-D'.format(input1.dim())
    # assert input2.dim() == 3, 'Expected 3-D tensor, but got {}-D'.format(input2.dim())
    # assert input1.size(2) == input2.size(2)
