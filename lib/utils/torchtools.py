...
__all__ = ['save_checkpoint', 'load_checkpoint', 'resume_from_checkpoint',
           'open_all_layers', 'open_specified_layers', 'fix_specified_layers', 'count_num_param',
...
def open_all_layers(model):
    ...
    Examples::
        >>> from lib.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from lib.utils import open_specified_layers
...
def fix_specified_layers(model, fixed_layers):
    r"""Fixes specified layers in model for training while keeping
    other layers training.

    Args:
        model (nn.Module): neural net model.
        fixed_layers (str or list): layers frozen.
