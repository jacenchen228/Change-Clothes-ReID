...
__all__ = ['dim_graph_hie_resnet50_C']
...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes, loss, block_rgb, layers_rgb, block_contour, layers_contour, zero_init_residual=False,
        ...
        self.parts_avgpool = nn.AdaptiveAvgPool2d((self.part_num, 3))
...
"""ResNet"""
def dim_graph_hie_resnet50_C(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = MyModel(
