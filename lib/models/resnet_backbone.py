...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes, block_rgb, layers_rgb, zero_init_residual=False,
                 ...
                 norm_layer=None, last_stride=2, fc_dims=None, dropout_p=None, input_channel=3,
                 **kwargs):
    ...
    def forward(self, x1, return_featuremaps=False):
...
def resnet50(num_classes=150, loss='softmax', pretrained=True, input_channel=3, **kwargs):
    model = MyModel(
