...
class ResNet(nn.Module):
    def __init__(self, last_stride,
                 ...
                 groups=1, width_per_group=64, num_classes=1000):
    ...
    def forward(self, x_unuse, x):
        ...
        v1 = self.global_avgpool(x)
        v2 = self.global_maxpool(x)
...
def resnet50_strong(num_classes=1000, pretrained=False, last_stride=1, with_ibn=False,
    ...
    return _resnet(pretrained=pretrained, last_stride=last_stride,
                   ...
                   block=Bottleneck, layers=[3, 4, 6, 3], model_path=model_path, model_name='resnet50', num_classes=num_classes)
