...
from lib.lib3D import hmr, SMPL
...
class Model_3D_2stream(nn.Module):
    def __init__(self, num_classes, batch_size, **kwargs):
        ...
        self.estimator_3D = hmr(smpl_mean_params='/home/jiaxing/SPIN-master/data/smpl_mean_params.npz')
    ...
    def forward(self, inputs1, inputs2=None, return_featuremaps=False, return_params_3D=False):
        v_3d, v_displacement, pred_rotmat, pred_betas, pred_cam = self.estimator_3D(inputs1)
...
def model_3D_2stream_v1(num_classes=150, loss='softmax', **kwargs):
