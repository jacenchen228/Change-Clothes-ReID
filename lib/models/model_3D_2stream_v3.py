...
class Model_3D_2stream(nn.Module):
    ...
    def forward(self, inputs1, inputs2, real_params=None, return_params3D=False):
        ...
        f3d, pred_rotmats, pred_betas, pred_cam, pred_displace = self.estimator3d(inputs2)
        ...
        if not self.training:
            ...
            # return [vconcate, vconcate_bnneck]
...
def model_3D_2stream_v3(num_classes=150, loss='softmax', **kwargs):
