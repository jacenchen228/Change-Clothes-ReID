...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes, loss, block_rgb, layers_rgb, block_contour, layers_contour, zero_init_residual=False,
        ...
        self.parts_avgpool_rgb = GeneralizedMeanPoolingP(output_size=(self.part_num_rgb, 1))
        ...
        self.parts_avgpool_contour = GeneralizedMeanPoolingP(output_size=(self.part_num_rgb, 1))
    ...
    def forward(self, x1, x2, return_featuremaps=False):
        f1, f2, f2_part = self.featuremaps(x1, x2)
        ...
        if not self.training:
            ...
            return [test_feat0, test_feat1, test_feat3]
        ...
        return [y1, y1_parts, y2], [v1, v1_parts.view(v1_parts.size(0), -1), v2], ej, em, ej_part, em_part
...
"""ResNet"""
def dim_gcn_modelv1(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = MyModel(
