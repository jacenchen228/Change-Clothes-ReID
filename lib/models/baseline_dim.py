...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes, loss, block_rgb, layers_rgb, block_contour, layers_contour, zero_init_residual=False,
        ...
        self.discriminator_part = PartDiscriminator(in_feature_dim=2048, feature_dim=512,
                                                    vec_feature_dim=self.reduced_dim, part_height=self.part_height)
...
"""ResNet"""
def my_baseline_dim(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = MyModel(
